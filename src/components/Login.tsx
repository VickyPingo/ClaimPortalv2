...
export default function Login({ roleType }: { roleType?: 'client' | 'broker' | null }) {
  ...
  const isBrokerSubdomain =
    hostname.includes('.claimsportal.co.za') ||
    hostname.includes('independi') ||
    hostname === 'localhost';
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        {loading && !error && (
          <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-center gap-3">
            ...
            <p className="text-sm text-blue-800 font-medium">Authorising account...</p>
          </div>
        )}
